...
By default, two sweep strategies are enabled: single transaction threshold sweep and balance sweep. You can adjust the parameters of the sweep strategy as needed or add other sweep strategies. For detailed configuration steps, refer to [Auto token sweeping settings](/en/portal/auto-sweep-settings).
